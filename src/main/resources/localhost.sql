...
--
-- Хост: localhost:3306
-- Время создания: Мар 21 2019 г., 15:33
...
--
CREATE DATABASE IF NOT EXISTS `CalculateSalary` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `CalculateSalary`;
...
('root', '[{\"db\":\"mysql\",\"table\":\"user\"}]'),
('user0', '[{\"db\":\"CalculateSalary\",\"table\":\"managers\"}]');
...
('phpmyadmin', '2019-03-20 13:39:37', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}'),
('root', '2019-03-20 13:54:06', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}'),
('user0', '2019-03-20 14:04:10', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
